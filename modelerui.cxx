...
string fp;
vector<plyloader::Point>  _vertices;
vector<plyloader::Point>  _face_real;
vector<plyloader::Face>  _indices;
...
inline void ModelerUserInterface::cb_OpenPos_i(Fl_Menu_*, void*) {
	...
	if (filename)
	{
		...
		f_op >> elevation >> azimuth >> dolly >> twist >> x >> y >> z;
...
inline void ModelerUserInterface::plyload(Fl_Menu_*, void*) {
	char *filename= NULL;
	filename = fl_file_chooser("Open .ply File", "*.ply", NULL);
	fp = filename;
	cout << "from ui path: " << fp << endl;
	string f_path = fp;
	plyloader test;
	test.load(f_path, _vertices, _face_real, _indices);
	m_modelerView->redraw();
	
}


void ModelerUserInterface::cb_LoadMesh(Fl_Menu_* o, void* v) {
	((ModelerUserInterface*)(o->parent()->user_data()))->plyload(o, v);
}
...
inline void ModelerUserInterface::cb_m_controlsAnimOnMenu_i(Fl_Menu_*, void*) {
  cout << " get_animation_value " << m_controlsAnimOnMenu->value() << " ";
  animation_check = (m_controlsAnimOnMenu->value() == 0) ? false : true;
...
Fl_Menu_Item ModelerUserInterface::menu_m_controlsMenuBar[] = {
 ...
 {"Load Mesh File", 0, (Fl_Callback*)ModelerUserInterface::cb_LoadMesh, 0, 0, 0, 0, 14, 0},
 {"Exit", 0,  (Fl_Callback*)ModelerUserInterface::cb_Exit, 0, 128, 0, 0, 14, 0 },
 {0},
...
ModelerUserInterface::ModelerUserInterface() {
  Fl_Window* w;
  { Fl_Window* o = m_controlsWindow = new Fl_Window(395, 326, "Modeler");
    w = o;
